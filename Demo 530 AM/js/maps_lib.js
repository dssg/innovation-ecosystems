(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        // Found at http://uscensusbureau.github.io/citysdk/gettingstarted.html or http://api.census.gov/data/citysdk.html
        // Important! this key is for demonstration purposes. please register your own.
        this.censusApiKey = options.censusApiKey || "",
        ...
        //-----custom initializers-----
        var censusSDK = new CitySDK();
        self.census = censusSDK.modules.census;
        self.census.enable(self.censusApiKey);
    ...
    //-----custom functions-----
    MapsLib.prototype.getTractGeo = function(pin,map){
        var self = this;
        if (!pin) return null;
        var request = {
            "lat": pin.lat(),
        ...
        self.census.GEORequest(request, function(response){
...
*/
        self.getgeoCondition(address, function (geoCondition) {
            ...
            self.getTractGeo(self.currentPinpoint,self.map);
        });
